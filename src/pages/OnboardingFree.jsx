...
const OnboardingFree = () => {
  ...
  return (
    <div className="w-full relative bg-neutral-900 h-[100vh] overflow-hidden">
      <section className="absolute w-full right-[0rem] top-[20vh]  h-[calc(100vh_-_20vh)] left-[0rem] rounded-t-21xl rounded-b-none bg-neutral-800 grid grid-flow-row justify-items-center  pt-[1.25rem] px-[1.25rem] pb-[2.5rem] box-border gap-[3rem] text-center text-[2rem] text-neutral-100 font-button-2-bold">
