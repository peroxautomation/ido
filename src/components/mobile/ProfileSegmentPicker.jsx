...
const ProfileSegmentPicker = ({ current, onClick }) => {
  ...
  if (current == "MyDance") {
    ...
    >
      ...
      >
        <div
          className="relative text-[0.75rem] leading-[1rem] font-button-1-regular text-neutral-500 text-left"
        >
          My dance
        </div>
        <svg
      ...
      >
        <div className={`relative text-[0.75rem] leading-[1rem] font-button-1-regular text-neutral-500 text-left ${textClass}`}>
          Cover
        </div>
      </button>
      <button
...
ProfileSegmentPicker.propTypes = {
