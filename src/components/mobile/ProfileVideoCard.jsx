...
const ProfileVideoCard = ({ className = "", view = 'User' }) => {
  ...
  return (
    <div
      className={`w-[10rem] relative z-0 rounded-xl h-[10rem] overflow-hidden shrink-0 bg-[url('/public/card1@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-[0.875rem] text-neutral-100 font-button-1-regular ${className}`}
    >
      ...
      <div onClick={onMenuClick} className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[0.5rem] right-[0.5rem] w-[1.5rem] h-[1.5rem] overflow-hidden">
        <img
