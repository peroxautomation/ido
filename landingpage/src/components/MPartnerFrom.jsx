...
import MPartnerModal from "./MPartnerModal";
...
const MPartnerFrom = () => {
  ...
  return (
    <div className="absolute top-[122px] left-[calc(50%_-_168px)] flex flex-col items-center justify-start gap-[24px] text-center text-base text-neutral-100 font-h2-regular overflow-y-auto">
      <div className="relative text-5xl leading-[32px] whitespace-pre-wrap">
        Become a partner
      </div>
      <div className="flex flex-col items-start justify-start gap-[16px] text-left">
        <div className="w-[335px] flex flex-col items-start justify-start">
        ...
        <div className="w-[335px] flex flex-col items-start justify-start">
          <div className="self-stretch flex flex-row items-start justify-end pt-0 px-0 pb-1">
            <div className="flex-1 relative leading-[24px]">Company name *</div>
            <img
              className="w-6 relative h-6 overflow-hidden shrink-0 hidden"
              alt=""
              src="/hugeiconinterfacesolidinformation.svg"
        ...
        <div className="w-[335px] flex flex-col items-start justify-start">
          ...
          <div className="self-stretch rounded-xl bg-white-8 flex flex-row items-center justify-start py-2.5 px-4 gap-[8px]">
            ...
            />
            <div className="flex-1 relative leading-[24px]">Please select</div>
            <img
        ...
        <div className="w-[335px] flex flex-row items-start justify-start gap-[8px] text-sm">
          <input className="m-0 w-6 relative h-6 accent-primary-500" 
          type="checkbox" />
      ...
      className="w-[335px] flex flex-row items-center justify-center py-2.5 px-2 box-border gap-[8px] touch-btn-secondary">  
