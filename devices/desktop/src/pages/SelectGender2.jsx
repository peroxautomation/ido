  ...
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      <StateDefaultSizeBigDevic
        ...
        inputText="Enter your user name"
        ...
        stateDefaultSizeBigDevicTop="172px"
      ...
      <StateDefaultSizeBigDevic
        ...
        stateDefaultSizeBigDevicWidth="340px"
        stateDefaultSizeBigDevicPosition="absolute"
        stateDefaultSizeBigDevicTop="260px"
        stateDefaultSizeBigDevicRight="unset"
        stateDefaultSizeBigDevicLeft="202px"
        inputGap="unset"
        inputBorder="unset"
      ...
      <StateDefaultSizeBigDevic
        ...
        stateDefaultSizeBigDevicWidth="340px"
        stateDefaultSizeBigDevicPosition="absolute"
        stateDefaultSizeBigDevicTop="348px"
        stateDefaultSizeBigDevicRight="unset"
        stateDefaultSizeBigDevicLeft="202px"
        inputGap="unset"
        inputBorder="unset"
      ...
      <SizeBiggerStateDefaultDe1
        ...
        sizeBiggerStateDefaultDePosition="absolute"
        sizeBiggerStateDefaultDeTop="436px"
        sizeBiggerStateDefaultDeLeft="202px"
      ...
      <SizeBiggerStateDefaultDe1
        labelText="Birthday"
        hugeIconmultimediaAndAudi="/hugeiconmultimedia-and-audiosolidmusic-01.svg"
        inputText="Select your birthday"
        hugeIconarrowssoliddirect="/hugeicontime-and-dateoutlinecalendar.svg"
        helperText="Helper text"
        helperText={false}
        label
        leftIcon={false}
        ...
        sizeBiggerStateDefaultDeWidth="340px"
        sizeBiggerStateDefaultDePosition="absolute"
        sizeBiggerStateDefaultDeTop="524px"
        sizeBiggerStateDefaultDeLeft="202px"
        sizeBiggerStateDefaultDeAlignSelf="unset"
        sizeBiggerStateDefaultDeHeight="unset"
        labelWidth="340px"
      ...
      <SizeBigStateSecondaryDev
        ...
        leftIcon={false}
        rightIcon={false}
        sizeBigStateSecondaryDevBackgroundColor="#efb5c3"
        ...
        sizeBigStateSecondaryDevTop="612px"
        cTAColor="#fff"
      />
      <div className="absolute top-[516px] left-[calc(50%_-_170px)] shadow-[0px_8px_40px_rgba(0,_0,_0,_0.5)] rounded-xl w-[340px] overflow-hidden flex flex-col items-start justify-start">
