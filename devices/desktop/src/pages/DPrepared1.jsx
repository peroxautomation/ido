  ...
  return (
    <div className="w-full relative bg-neutral-900 h-[1024px] overflow-hidden">
      ...
      <VariantsReadyVideoEditBt
        ...
        variantsReadyVideoEditBtWidth="calc(100% - 1024px)"
        variantsReadyVideoEditBtPosition="absolute"
        variantsReadyVideoEditBtTop="284px"
        variantsReadyVideoEditBtRight="512px"
        variantsReadyVideoEditBtLeft="512px"
        variantsReadyVideoEditBtHeight="calc(100% - 568px)"
        variantsReadyVideoEditBtBottom="284px"
        frameDivBackgroundImage="url('/frame-7118@3x.png')"
      />
    </div>
  );
};

export default DPrepared1;
