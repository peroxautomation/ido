  ...
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      <Autosuggest1
        ...
        all2="Cambodia"
        allHref1="https://www.britannica.com/place/Cambodia"
        all3="Denmark"
        allHref2="https://www.britannica.com/place/Denmark"
        all4="Ecuador"
        allHref3="https://www.britannica.com/place/Ecuador"
        all5="Finland"
        allHref4="https://www.britannica.com/place/Finland"
        all6="Germany"
        allHref5="https://www.britannica.com/place/Germany"
        all7="Zimbabwe"
      />
    </div>
  );
