...
const DefaultOTP2 = () => {
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden text-center text-21xl text-neutral-100 font-overline-regular">
      <div className="absolute w-[calc(100%_-_409px)] top-[411px] right-[204px] left-[205px] flex flex-col items-center justify-start gap-[24px]">
