...
import VariantsReadyVideoEditBt from "../components/VariantsReadyVideoEditBt";

const ResultOfSelecting1 = () => {
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      <VariantsReadyVideoEditBt
        hugeIconinterfacesolidplu="/hugeiconinterfacesolidplus.svg"
        variantsReadyVideoEditBtWidth="calc(100% - 328px)"
        variantsReadyVideoEditBtPosition="absolute"
        variantsReadyVideoEditBtTop="338px"
        variantsReadyVideoEditBtRight="164px"
        variantsReadyVideoEditBtLeft="164px"
        variantsReadyVideoEditBtHeight="456px"
        variantsReadyVideoEditBtBottom="unset"
        frameDivBackgroundImage="url('/frame-71183@3x.png')"
      />
    </div>
  );
};

export default ResultOfSelecting1;
