...
import VariantsCommentDeviceTable from "../components/VariantsCommentDeviceTable";
...
const Comment1 = () => {
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      />
      <VariantsCommentDeviceTable
        ellipse1198="/ellipse-1198@2x.png"
        variantsCommentDeviceTablWidth="calc(100% - 226px)"
        variantsCommentDeviceTablHeight="calc(100% - 525px)"
        variantsCommentDeviceTablPosition="absolute"
        variantsCommentDeviceTablTop="444px"
        variantsCommentDeviceTablRight="113px"
        variantsCommentDeviceTablBottom="81px"
        variantsCommentDeviceTablLeft="113px"
      />
    </div>
  );
};
