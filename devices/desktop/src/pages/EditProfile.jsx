...
const EditProfile = () => {
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      <VariantsEditProfile
        ellipse1255="/ellipse-12551@2x.png"
        hugeIconinterfacesolidinf="/hugeiconinterfacesolidinformation3.svg"
        input="Julia Hilton"
        hugeIconinterfacesolideye="/hugeiconinterfacesolideye.svg"
        phinfoLight="/phinfolight1.svg"
        hugeIconeducationsolidpen="/hugeiconeducationsolidpencil@2x.png"
        variantsEditProfileWidth="calc(100% - 328px)"
        variantsEditProfileHeight="calc(100% - 677px)"
        variantsEditProfilePosition="absolute"
        variantsEditProfileTop="338px"
        variantsEditProfileRight="164px"
        variantsEditProfileBottom="339px"
        variantsEditProfileLeft="164px"
      />
    </div>
  );
};
