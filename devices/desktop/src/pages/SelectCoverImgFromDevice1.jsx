...
import VariantsSelectFromDevice from "../components/VariantsSelectFromDevice";

const SelectCoverImgFromDevice1 = () => {
  return (
    <div className="w-full relative bg-neutral-900 h-[1133px] overflow-hidden">
      ...
      <VariantsSelectFromDevice
        hugeIconfilesAndFolderout="/hugeiconfiles-and-folderoutlinefilevideo1.svg"
        hugeIconeducationsolidpen="/hugeiconeducationsolidpencil3@2x.png"
        variantsSelectFromDeviceWidth="calc(100% - 328px)"
        variantsSelectFromDeviceHeight="calc(100% - 677px)"
        variantsSelectFromDevicePosition="absolute"
        variantsSelectFromDeviceTop="338px"
        variantsSelectFromDeviceRight="164px"
        variantsSelectFromDeviceBottom="339px"
        variantsSelectFromDeviceLeft="164px"
      />
    </div>
  );
};

export default SelectCoverImgFromDevice1;
