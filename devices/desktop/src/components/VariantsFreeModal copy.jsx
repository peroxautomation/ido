...
VariantsFreeModal.propTypes = {
  className: PropTypes.string,
  hugeIconinterfacesolidplu: PropTypes.string,

  /** Style props */
  variantsFreeModalWidth: PropTypes.any,
  variantsFreeModalPosition: PropTypes.any,
  variantsFreeModalTop: PropTypes.any,
  variantsFreeModalRight: PropTypes.any,
  variantsFreeModalLeft: PropTypes.any,
};

export default VariantsFreeModal;
