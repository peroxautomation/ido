...
const ReplyO = ({
  ...
  return (
    <div
      className={`box-border flex flex-col items-end justify-start py-6 px-0 gap-[8px] text-left text-base text-neutral-100 font-overline-regular self-stretch border-b-[1px] border-solid border-neutral-700 ${className}`}
    >
      ...
      <StateDefault replyToCommentReplyToComm="Reply to comment" />
    </div>
  );
};
