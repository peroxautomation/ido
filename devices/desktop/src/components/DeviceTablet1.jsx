...
const DeviceTablet1 = (props) => {
  ...
  return (
    <div
      ...
      className={`w-[528px] max-w-full flex flex-col items-start justify-start gap-[16px] text-left text-xl text-neutral-100 font-overline-regular ${className}`}
      style={deviceTablet2Style}
    >
      <img
        className="ml-6 self-stretch object-center relative rounded-xl max-w-full overflow-hidden h-[400px] shrink-0 object-cover"
        alt=""
        src={front}
      ...
      {info && (
        ...
        >
          ...
          <div
            className="cursor-pointer hover:opacity-80  rounded-xl bg-white-8 flex flex-row items-start justify-start p-2"
